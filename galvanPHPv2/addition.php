...
<?php echo "<legend><b>Addition</b></legend>" ?>
...
<tr>
<td>
<button id="b1" class="btn-1" type="submit" name="submit" disabled="disabled">ADD <img class="calc" src="Add.png"></button>
</td>
<td>
...
<!--Result Field-->
<h4><label class="Result" name="number3">The Sum of two numbers: <?php if(isset($_POST['submit']))  
  {  
