...
<?php echo "<legend><b>Division</b></legend>" ?>
...
<tr>
<td>
<button id="b1" class="btn-1" type="submit" name="submit" disabled="disabled">DIVIDE <img class="calc" src="Divide.png"></button>
</td>
<td>
...
<!--Result Field-->
<h4><label class="Result" name="number3">The Quotient of two numbers: <?php if(isset($_POST['submit']))  
  {  
