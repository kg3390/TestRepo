<html>
<head></head>
<body style="background-image: linear-gradient(to bottom right, #424949, #ecf0f1 );"></body>
...
<?php echo "<legend><b>Subtraction</b></legend>" ?>
...
<tr>
<td>
<button id="b1" class="btn-1" type="submit" name="submit" disabled="disabled">SUBTRACT <img class="calc" src="Subtract.png"></button>
</td>
<td>
...
<!--Result Field-->
<h4><label class="Result" name="number3">The Difference of two numbers: <?php if(isset($_POST['submit']))  
  {  
