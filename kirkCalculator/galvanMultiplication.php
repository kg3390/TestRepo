...
<fieldset>
    <h2><center><font color="Blue"; face="Tahoma";>MULTIPLICATION</font></center></h2>
    </fieldset>
    <br>
...
<h3><font color="Blue"; face="Tahoma";>
    ...
    <button id="b1" 
        style="background-color: green; 
                ...
                width:150px; 
                height:65px" 
        onclick="fun();return false">MULTIPLY</button>
...
<p id="res">    
<h3><font color="Blue"; face="Tahoma";>
    <label id="l1"><font color="red">The Product of Two Numbers :</font></label>
    <input id="multiply" style="font-size: 15pt;">
</p>
</p>
</center>    
