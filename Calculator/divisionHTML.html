...
<fieldset>
    <h2><center><font color="Blue"; face="Tahoma";>DIVISION</font></center></h2>
    </fieldset>
    <br>
...
<h3><font color="Blue"; face="Tahoma";>
    ...
    <button id="b1" 
        style="background-color: green; 
                ...
                width:150px; 
                height:65px" 
        onclick="fun();return false">DIVIDE</button>
...
<p id="res">    
<h3><font color="Blue"; face="Tahoma";>
    <label id="l1"><font color="red">The Quotient of Two Numbers :</font></label>
    <input id="divide" style="font-size: 15pt;">
</p>
</p>
</center>    
